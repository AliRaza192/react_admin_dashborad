...
const ProductsTable = () => {
  ...
  const [fillterdProducts, setFillterdProducts] = useState(productsData);
            ...
            {fillterdProducts.map((product) => (
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100 flex gap-2 items-center">
                  <img
                    src="https://images.unsplash.com/photo-1511300961358-669ca3ad05af?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHdpcmVsZXNzJTIwZWFycGhvbmV8ZW58MHx8MHx8fDA%3D"
                    alt="Product Img"
